...
";
    ...
    <div id="modalBrain" class="health-modal">
        <div class="health-modal-content">
            ...
            <p class="disclaimer" style="color: #a00; font-weight: bold; margin-top: 15px; padding: 10px; border: 1px solid #f00; border-radius: 4px; background-color: #ffeaea;">
                Disclaimer: The prediction is generated by an AI model and is **not a medical diagnosis**. It is for informational purposes only. Always consult a qualified healthcare professional for any health concerns.
            </p>

            <form class="health-form" id="brain-tumor-form" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Upload Brain Scan Image (MRI)</label>
                    <small class="sub-label">Supported formats: JPG, PNG, JPEG</small>
                    <input type="file" name="brain_image" accept="image/*" required>
                </div>

                <div class="form-group">
                    <img id="previewImage" src="#" alt="Image Preview" style="display:none; max-width:100%; margin-top:10px; border: 1px solid #ccc; border-radius: 4px;">
                </div>

                <div class="form-group">
                    <button type="submit" class="health-submit">Detect Tumor</button>
                </div>
            </form>

            <div id="result" style="margin-top: 15px; font-weight: bold; font-size: 1.1em;"></div>
        </div>
    </div>
